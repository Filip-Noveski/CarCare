...
# Technologies
The **Car Care** application is built on the **.NET Core** framework, utilising **Windows Presentation Foundation (WPF)** for the user-interface.
